...
;;; Import contract: users opt in through =:poo-flow/modules/agent-sandbox/cube=.
...
(import :poo-flow/modules/agent-sandbox/profile
        ...
        :poo-flow/modules/agent-sandbox/cube-interface)

(export make-cube-agent-sandbox-profile-descriptor
        make-cube-agent-sandbox-profile
        (import: :poo-flow/modules/agent-sandbox/cube-interface))
