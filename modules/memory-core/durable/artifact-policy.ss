...
(import (only-in :clan/poo/object .o .ref)
        ...
        :poo-flow/modules/memory-core/durable/artifact-profile
        :poo-flow/modules/memory-core/durable/artifact-object
        :poo-flow/modules/memory-core/durable/artifact-validation)
