...
(import :poo-flow/modules/tool-core/objects-spec
        :poo-flow/modules/tool-core/objects-catalog
        :poo-flow/modules/tool-core/objects-handoff
        :poo-flow/modules/tool-core/objects-receipt
        :poo-flow/modules/tool-core/objects-builtin)
