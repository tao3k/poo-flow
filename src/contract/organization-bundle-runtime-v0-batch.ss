...
(def (poo-flow-runtime-v0-event event-kind-value flags-value sequence-value
  ...
  (.o (kind 'poo-flow.runtime-v0.event.1)
      (layout-version +poo-flow-runtime-v0-layout-version+)
      (header-bytes +poo-flow-runtime-v0-event-header-bytes+)
      (event-kind event-kind-value) (flags flags-value)
      (sequence sequence-value)
      (event-identity event-identity-value)
      (correlation-identity correlation-identity-value)
      (authorization-identity authorization-identity-value)
      (payload-offset payload-offset-value)
      (payload-length payload-length-value)
      (deadline-mono-ns deadline-value)
      (required-evidence-bits evidence-bits-value)
      (reserved0 0)))
