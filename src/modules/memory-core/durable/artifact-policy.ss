...
(import (only-in :clan/poo/object .o .ref)
        ...
        :poo-flow/src/modules/memory-core/durable/artifact-profile
        :poo-flow/src/modules/memory-core/durable/artifact-object
        :poo-flow/src/modules/memory-core/durable/artifact-validation)
