...
;; : (-> Syntax Syntax)
;;   | doc m%
;;       Resolve a loaded profile fragment name to the binding generated by
;;       load!. This macro is intentionally separate from use-composition so the
;;       composition grammar owner stays cheap to recompile.
;;       # Examples
;;       (poo-flow-composition-profile-module langchain)
;;       ;; => poo-flow-custom-<module>-langchain-module
;;   | boundary: expands only to an identifier; no runtime registry is added
;;     %
