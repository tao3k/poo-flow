...
(def (poo-flow-cedar-governance-snapshot
      profile-value assessment-value context-value proof-value policy-values
  ...
  (unless (poo-flow-governance-profile? profile-value)
    (error "Cedar governance projection requires an admitted Profile"
           profile-value))
  (unless (poo-flow-governance-assessment? assessment-value)
    (error "Cedar governance projection requires a typed threat assessment"
           assessment-value))
  (unless (equal? (.ref profile-value 'identity)
                  (.ref assessment-value 'profile-identity))
    (error "Governance Profile and threat assessment identity mismatch"
           (.ref profile-value 'identity)
           (.ref assessment-value 'profile-identity)))
  (unless (.ref assessment-value 'handoff-ready?)
    (error "unresolved Governance threats block Cedar handoff"
           (.ref assessment-value 'unresolved-threats)))
  ...
  (.cc
   (poo-flow-cedar-authority-snapshot
    ...
    capability-values)
   'governance-assessment assessment-value))
